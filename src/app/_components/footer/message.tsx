...
const Message = () => {
  ...
  return (
    <dialog
      className={twMerge(
        'fixed right-0 bottom-10 left-0 z-9999 m-auto flex w-[90vw] flex-col items-center justify-center gap-2 bg-black p-2 font-semibold text-zinc-50 transition duration-200 ease-in-out md:w-2/3 xl:w-[30vw] dark:bg-white dark:text-zinc-200',
        message?.error && 'bg-red-500 dark:bg-red-600'
      )}>
      <div className=":text-2xl flex w-full items-center justify-center bg-sky-500 p-2 md:text-lg dark:bg-sky-600">

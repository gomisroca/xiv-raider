...
export function LayoutBackground({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative overflow-x-hidden bg-zinc-50 dark:bg-zinc-950">
      ...
      <div className="absolute top-16 right-16 h-32 w-32 rotate-45 border-4 border-sky-500 opacity-80 dark:border-sky-600"></div>
      <div className="absolute top-24 right-24 h-24 w-24 rotate-45 border-2 border-yellow-400 opacity-60 dark:border-yellow-500"></div>

      {/* Flowing Curves */}
      <div className="absolute top-32 left-16 h-64 w-64 opacity-30">
      ...
      <div className="absolute bottom-16 left-16 h-48 w-48 opacity-40">
        <svg viewBox="0 0 200 200" className="h-full w-full">
      ...
      <div className="absolute top-1/4 right-1/4 h-24 w-2 rotate-12 transform bg-sky-500 opacity-70 dark:bg-sky-600"></div>
      <div className="absolute top-1/4 right-1/4 h-2 w-24 rotate-12 transform bg-sky-500 opacity-70 dark:bg-sky-600"></div>

      {/* Diamond Shapes */}
      <div className="absolute right-1/3 bottom-1/3 h-8 w-8 rotate-45 transform bg-yellow-400 opacity-60 dark:bg-yellow-500"></div>
      <div className="absolute right-1/3 bottom-1/3 h-4 w-4 translate-x-6 translate-y-6 rotate-45 transform bg-sky-500 opacity-80 dark:bg-sky-600"></div>
      ...
      <div className="absolute right-1/6 bottom-1/4 h-20 w-20 rotate-45 transform border-t-4 border-l-4 border-sky-500 opacity-70 dark:border-sky-600"></div>

      {/* Persona-style Frame Elements */}
      <div className="absolute top-8 left-8 h-1 w-16 bg-sky-500 dark:bg-sky-600"></div>
      <div className="absolute top-8 left-8 h-16 w-1 bg-sky-500 dark:bg-sky-600"></div>
      <div className="absolute right-8 bottom-8 h-1 w-16 bg-yellow-400 dark:bg-yellow-500"></div>
      <div className="absolute right-8 bottom-8 h-16 w-1 bg-yellow-400 dark:bg-yellow-500"></div>
